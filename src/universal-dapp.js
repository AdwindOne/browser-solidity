...
// NOTE this function was named before "appendChild".
...
// this returns a DOM element.
// all buttons in contract and instances (create, functions, etc.)
...
// NOTE used in all transaction functions (create, delegate...)
